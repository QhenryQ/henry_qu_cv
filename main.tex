...
\section{Industry Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Data and Statistical Consultant (part-time, 5hr/week)}{Jun 2022 \textbf{--} Present}
        \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Founding Partner, Data Science}{Jan 2021 \textbf{--} Present}
        \resumeItemListStart
          \resumeItem{Establish a data-driven product development culture by driving the definition, tracking, and
          operationalizing of feature-, product-, and company-level metrics.}
          \resumeItem{Develop and socialize dashboards, reports, and other ways of enabling the team and company to answer product data questions in a self-serve way.}
          \resumeItem{Fundraising and external communication of products.}
        \resumeItemListEnd
