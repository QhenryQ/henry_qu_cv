...
\begin{flushleft}
  \begin{tabularx}{\textwidth}{@{}p{3cm}@{\hspace{0.01cm}}X@{}}
    \multirow{3}{3cm}{2022--09--29\\ \hspace{0.1cm} to \\2023--07--30} & Exhibition Consultant and Volunteer for “Journeys \begin{CJK*}{UTF8}{gbsn}旅途\end{CJK*}: Boys of the Chinese Educational Mission” at Connecticut Historical Society Museum and Library, Hartford, Connecticut \emph{\href{https://chs.org/exhibition/journeys/ }{\color{blue}Link}}\\
  \end{tabularx}
\end{flushleft}
