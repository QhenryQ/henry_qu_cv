...
\section{Industry Experience}
  ...
  {Founding Partner, Data Science}{Jan 2021 \textbf{--} Present}
    \resumeItemListStart
    ...
    {Lead Data Scientist (part-time)}{Sep 2022 \textbf{--} Present}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Senior Data Scientist}{Aug 2020 \textbf{--} July 2024}
        \resumeItemListStart
            \resumeItem{Built and maintained data extraction, transform, and analysis pipelines for managed agriculture systems.}
            \resumeItem{Designed and implemented machine learning models for irrigation detection using on-farm sensor data, enabled program scaling by 261\% (US Patent 18/391,335, Irrigation System in Agriculture Environment).}
