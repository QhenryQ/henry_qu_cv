...
\usepackage{setspace} % custom line 
\usepackage[maxcitenames=6, minnames=3 ]{biblatex}
\addbibresource[]{biblio.bib}

% what is your name?
\newcommand{\myname}{Yuanshuo "Henry" Qu}
...
\begin{document}
    ...
    \begin{minipage}[t]{0.295\textwidth}
        ...
        \flushright{}
        \href{mailto:zhirluo@gmail.com}{henry.yqu@gmail.com} \\
        +1 732 485 1243 \\
        \href{https://orcid.org/0000-0003-2046-469X}{orcid:0000-0003-2046-469X}
    \end{minipage}

    \section*{Education}
    
    \begin{tablist}
      \item[Ph.D.] \tab{}Plant Breeding and Genetics, Rutgers University, New Brunswick, USA, 2014-2020
      \item[M.S.] \tab{}Statistics, Rutgers University, New Brunswick, USA, 2015-2017
      \item[B.S.] \tab{}Plant Science, Rutgers University, New Brunswick, USA, 2011-2013
      \item[B.E.] \tab{}Food Science and Engineering, Shanghai Jiao Tong University, Shanghai, China, 2008-2011
    \end{tablist}
